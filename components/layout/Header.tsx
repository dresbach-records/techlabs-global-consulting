      ...
      {mobileMenuOpen && (
        <div className="fixed inset-0 z-[60] bg-black pt-32 px-10 lg:hidden animate-in fade-in">
          <div className="flex flex-col gap-8">
            <Navigation isMobile />
            <Link to="/start-consultation" className="bg-[#19C37D] text-black w-full py-6 rounded-sm font-black uppercase tracking-widest text-center text-sm mt-8">Consultation Now</Link>
          </div>
        </div>
      )}
    </header>
