...
const NotFound = () => (
  <div className="min-h-screen flex flex-col items-center justify-center bg-black text-center p-6">
    ...
    <h1 className="text-4xl font-black uppercase mb-4">Página não encontrada</h1>
...
export default function App() {
  ...
  const connectToAgent = () => {
    setIsLiveAgent(true);
    setChatMessages(prev => [...prev, { role: 'ai', text: 'Conectando você a um engenheiro de suporte Dresbach Hosting...' }]);
      ...
      <div className="relative min-h-screen bg-black text-[#EDEDED] antialiased">
        ...
        <main className="relative z-10">
          <Routes>
            ...
            <Route path="/sandbox/retorno/sucesso" element={<Success />} />
            <Route path="/sandbox/retorno/cancelado" element={<Cancelled />} />
            <Route path="/sandbox/retorno/erro" element={<Error />} />
            ...
            <Route path="/test/login" element={<AdminLogin />} />
            <Route path="/test/client/dashboard" element={<Dashboard />} />
            ...
            <div className="bg-[#0A0A0A] border-t sm:border border-[#2F2F2F] flex flex-col h-full overflow-hidden sm:rounded-lg">
              <div className="p-6 border-b border-[#2F2F2F] flex items-center justify-between bg-black">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                     <h3 className="text-xs font-black uppercase tracking-[0.2em]">{isLiveAgent ? 'Suporte de Engenharia' : 'Arquiteto de Soluções de IA'}</h3>
