    ...
    <footer className="py-40 border-t border-[#2F2F2F] bg-[#050505] relative z-10">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-20 mb-32">
          <div className="md:col-span-5">
            ...
            <p className="text-[#6B6B6B] text-[11px] font-mono uppercase tracking-[0.4em] max-w-sm mb-12 leading-loose">
              Engenharia de ecossistemas de elite. <br />
              Sede Internacional: Toronto, CA.
            </p>
          ...
          <div className="md:col-span-7 grid grid-cols-1 sm:grid-cols-3 gap-20">
            <div>
              <h6 className="text-[11px] font-black uppercase tracking-[0.5em] text-[#19C37D] mb-10 text-nowrap">Capacidades</h6>
            ...
            <div>
              <h6 className="text-[11px] font-black uppercase tracking-[0.5em] text-[#19C37D] mb-10 text-nowrap">Empresa</h6>
              <ul className="space-y-5 text-[10px] font-bold text-[#6B6B6B] uppercase tracking-[0.3em]">
            ...
            <div>
              <h6 className="text-[11px] font-black uppercase tracking-[0.5em] text-[#19C37D] mb-10 text-nowrap">Governança</h6>
              <ul className="space-y-5 text-[10px] font-bold text-[#6B6B6B] uppercase tracking-[0.3em]">
        ...
        <div className="pt-20 border-t border-[#2F2F2F] flex flex-col lg:flex-row justify-between items-center gap-12 relative">
          <span className="text-[10px] font-bold text-[#6B6B6B] uppercase tracking-[0.5em]">© 2024 TechLabs Consultoria Técnica | Operações Internacionais do Grupo Dresbach.</span>
          <div className="flex items-center gap-12">
            <span className="flex items-center gap-4 text-[10px] font-black text-[#6B6B6B] uppercase tracking-[0.4em]"><ShieldCheck size={14} className="text-[#19C37D]" /> ISO 27001 SEGURO</span>
            <span className="flex items-center gap-4 text-[10px] font-black text-[#6B6B6B] uppercase tracking-[0.4em]"><ShieldCheck size={14} className="text-[#19C37D]" /> COMPATÍVEL COM SOC2</span>
            <Link 
              to="/admin/login" 
