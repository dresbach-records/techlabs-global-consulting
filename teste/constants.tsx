...
export const DETAILED_PAGES: Record<string, DetailedPage> = {
  'services': {
    title: "Serviços",
    subtitle: "Catálogo de Capacidades Completo",
    ...
    content: ["Arquitetura Avançada", "Engenharia de Nuvem", "Integração de IA", "Auditoria de Segurança", "Escala de Plataforma"]
  },
  'systems-design': {
    title: "Design de Sistemas",
    ...
    blocks: [
      ...
      { title: "Resiliência", text: "Sistemas 'auto-curáveis' que mantêm a disponibilidade mesmo sob falhas catastróficas." }
    ]
  },
  'cloud-strategy': {
    title: "Estratégia de Nuvem",
    ...
    icon: <Cloud size={48} />,
    content: ["Integração FinOps", "Infraestrutura como Código", "Failover Multi-Regional", "Segurança Nativa da Nuvem"]
  },
  'ai-scaling': {
    title: "Escala de IA",
    ...
    icon: <Zap size={48} />,
    content: ["Orquestração de LLM", "Implementação de Vector DB", "Pipelines MLOps", "Otimização de Inferência"]
  },
  'tech-audit': {
    title: "Auditoria Técnica",
  ...
  'ecosystem': {
    ...
    content: ["Hospedagem", "Fábrica de Software", "Laboratórios de P&D", "Construção de Empreendimentos"]
  },
  'clients': {
    title: "Clientes",
  ...
  'data-privacy': {
    ...
    content: ["Criptografia de Ponta a Ponta", "Soberania de Dados", "Protocolos de Anonimização", "Privacidade por Design"]
  },
  'ethics-policy': {
  ...
  'compliance': {
    ...
    icon: <Lock size={48} />,
    content: ["ISO 27001", "SOC2 Tipo II", "GDPR", "PCI-DSS"]
  },
  'security': {
    title: "Segurança",
    ...
    content: ["Equipe Vermelha", "Caça a Ameaças", "Fortalecimento de Infraestrutura", "DevSecOps"]
  }
};
...
export const GOVERNANCE_LINKS = [
  ...
  { title: "Conformidade", path: 'compliance' as Path, icon: <Lock /> },
...
export const ECOSYSTEM: EcosystemBrand[] = [
  ...
  },
  {
    ...
    specialty: 'Infraestrutura de Nuvem',
...
export const CLIENTS = [
  "STRATOS CORP", "LOGÍSTICA GLOBAL", "SISTEMAS NEURAIS", "BANCO QUÂNTICO", "ENERGIA HELIOS", "VÉRTICE TECNOLOGIA"
];
