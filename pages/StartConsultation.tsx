      ...
      <footer className="relative z-10 w-full py-12 text-center">
        <div className="flex flex-col items-center gap-4">
          <div className="flex items-center gap-6 opacity-30 grayscale saturate-0 mb-4">
            <div className="h-6 w-20 bg-slate-400/30 rounded flex items-center justify-center text-[8px] font-black uppercase tracking-tighter">Verified Partner</div>
            <div className="h-6 w-16 bg-slate-400/30 rounded flex items-center justify-center text-[8px] font-black uppercase tracking-tighter">SSL Secure</div>
          </div>
